        ...
        <>
            ...
            >
                <div className="container px-4 text-center md:px-6 lg:gap-10 dark:text-white mx-auto">
                    <div className="space-y-3 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg px-8 pt-6 pb-8 mb-4 border-solid border-[1px] border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex mx-auto justify-center items-center gap-4 lg:gap-6 flex-wrap">
                        <div className="flex-1 sm:flex-none flex flex-col items-center gap-1 md:gap-2 lg:grid place-items-center/only-child bg-white dark:bg-gray-800 shadow-md sm:rounded-lg px-2 md:px-8 pt-3 md:pt-6 pb-4 md:pb-8 mb-4 dark:text-white border-solid border-[1px] border-gray-200 dark:border-gray-700">
                            ...
                            <ul className="gridtext-sm gap-2 md:text-base sm:text-left text-center">
                                <li className="sm:flex items-center sm:gap-2">
                                    <PlusIcon className="h-4 w-4 hidden sm:inline-block" />
                                    Unlimited projects
                                </li>
                                <li className="sm:flex items-center gap-2">
                                    <PlusIcon className="h-4 w-4 hidden sm:inline-block" />
                                ...
                                <li>
                                    <ul className="flex flex-col sm:flex-row gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
                                        <li
                                            role="button"
                            ...
                            <button
                                className="inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 py-2 px-4 text-center bg-gray-800 rounded-md text-white text-sm hover:bg-gray-700 focus:outline-none dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500 w-full"
                                type="submit"
                            >
                                Subscribe
                            </button>
